...
class Employee:
    def __init__(self,root):
        ...
        lbl_title=Label(self.root,text='EMPLOYEE MANAGEMENT SYSTEM',font=('times new roman',40,'bold'),fg='white',bg='blue')
        ...
        # Upper Frame
        upper_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,bg='white',text='Employee Information',font=('times new roman',14,'bold'),fg='red')
        ...
        button_add=Button(button_frame,text="Save",command=self.save,font=("arial",16,"bold"),width=13,fg='white',bg='blue')
        button_add.grid(row=0,column=0,padx=1,pady=6)

        button_update=Button(button_frame,text="Update",command=self.update_data,font=("arial",16,"bold"),width=13,fg='white',bg='blue')
        button_update.grid(row=1,column=0,padx=1,pady=6)

        button_delete=Button(button_frame,text="Delete",command=self.delete,font=("arial",16,"bold"),width=13,fg='white',bg='blue')
        button_delete.grid(row=2,column=0,padx=1,pady=6)

        button_clear=Button(button_frame,text="Clear",command=self.clear,font=("arial",16,"bold"),width=13,fg='white',bg='blue')
        button_clear.grid(row=3,column=0,padx=1,pady=6)


        # Down Frame
        down_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,bg='white',text='Employee Information Table',font=('times new roman',14,'bold'),fg='red')
        down_frame.place(x=10,y=270,width=1490,height=250)

        # Search Frame
        search_frame=LabelFrame(down_frame,bd=2,relief=RIDGE,bg='white',text='Search Employee Information',font=('times new roman',14,'bold'),fg='red')
        ...
        btn_search=Button(search_frame,text="Search",command=self.search,font=("arial",11,"bold"),width=14,bg='green',fg='white')
        btn_search.grid(row=0,column=3,padx=5)

        btn_search=Button(search_frame,text="Show All",command=self.fetch_data,font=("arial",11,"bold"),width=14,bg='green',fg='white')
    ...
    def save(self):
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='#Neelmani123@',database='Employee')
        ...
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='#Neelmani123@',database='Employee')
                    my_cursor=conn.cursor()
                    my_cursor.execute('update emp set Department=%s,Name=%s,Designition=%s,Email=%s,Address=%s,Married_status=%s,DOB=%s,DOJ=%s,id_proof_type=%s,Gender=%s,Phone=%s,Country=%s,Salary=%s where id_proof=%s',(
                                                                                                                                                                                                                            self.var_dep.get(),
                                                                                                                                                                                                                            self.var_name.get(),
                                                                                                                                                                                                                            self.var_designition.get(),
                                                                                                                                                                                                                            self.var_email.get(),
